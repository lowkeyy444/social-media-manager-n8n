...
export default function PostHistoryPage() {
  ...
  return (
    <div className="min-h-screen py-12 px-6 md:px-12 text-white">
      <motion.h1
        className="text-4xl font-extrabold text-center mb-10 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400"
        ...
        {posts.length === 0 ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {posts.map((post) => (
              <motion.div
                key={post._id}
                className="p-6 bg-[rgba(15,17,26,0.85)] border border-white/10 rounded-3xl shadow-2xl hover:shadow-[0_0_35px_#00ffff40] backdrop-blur-md transition-all"
              ...
              >
                ...
                <p className="text-gray-300 mb-3 line-clamp-4">{post.postText}</p>
